...
`signal_generator_0.1.3`，构建号为 `20260819.3`，内嵌 base `0.4.2`。

当前版本复用 base 提供的四种硬件配置支持、串口配置、Wi-Fi NVS、HTTPS 心跳、
...
| ESP32-S3 N16R8 | 1, 2, 4–8, 15–18, 21 | 16 MB Flash、8 MB OPI PSRAM；排除特殊引脚 |
...
单独编译某个板型时使用 `-e esp32-s3-supermini`、`-e esp32-s3-n16r8`、
